...
CREATE TABLE `top_performers` (
  ...
  KEY `exam_id` (`exam_id`),
  CONSTRAINT `top_performers_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`) ON DELETE CASCADE,
  CONSTRAINT `top_performers_ibfk_2` FOREIGN KEY (`module_id`) REFERENCES `module` (`module_id`) ON DELETE CASCADE,
  CONSTRAINT `top_performers_ibfk_3` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`) ON DELETE CASCADE,
...
LOCK TABLES `top_performers` WRITE;
